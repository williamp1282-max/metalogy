...
const NONCONF_SCRAP = [
  { id:"explosives", symbol:"UXO", name:"Explosives / UXO", subtitle:"Unexploded Ordnance & Energetic Materials", type:"nonconforming",
    desc:"Military ordnance (shells, grenades, mortar rounds, land mines), commercial explosives (blasting caps, detonators), or improvised devices mixed into scrap — either from demolition sites, military surplus, or conflict zones. A single detonation inside a shredder or EAF is catastrophic. All scrap from military demolition, construction excavation, or international import requires mandatory UXO screening.",
    uses:["Shredder Detonation / Facility Destruction","EAF Explosion — Fatalities","Mandatory Plant Evacuation","Regulatory Shutdown"],
    properties:{"Common Sources":"Military demolition, excavation fill, import scrap","Detection":"Visual + X-ray + metal detector","Response":"Immediate evacuation + EOD team","Historic Incidents":"Multiple shredder explosions worldwide"},
    grades:"No ISRI grade permits energetic materials. Any suspected UXO triggers immediate cessation of operations, yard evacuation, and call to an Explosive Ordnance Disposal (EOD) team. Import scrap from conflict regions (Eastern Europe, Middle East, Southeast Asia) carries elevated risk and may require documentary proof of UXO clearance.",
    millRole:"A detonation in a shredder shreds the machine itself — documented incidents have destroyed entire shredder lines worth $10–30M. In an EAF, the confined furnace shell amplifies the blast, potentially rupturing the vessel and killing operators on the floor. UXO is the only nonconforming scrap type where a single incident can result in mass casualties and permanent facility closure.",
    studentNote:"Scrap from old farm fields in France still turns up WWI artillery shells 100 years later. Construction crews in Vietnam routinely unearth unexploded bombs. When that metal gets sold as scrap and shipped to a yard, the shredder has no way to know. The 'bang' heard across a scrap yard at noon that makes everyone freeze is no joke — EOD teams are on speed-dial at every major scrap processor.",
    img:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Mines_501556_fh000026.jpg/330px-Mines_501556_fh000026.jpg" },
  ...
  { id:"closed-containers", symbol:"CC", name:"Closed Containers", subtitle:"Sealed & Pressurized Vessels in Charge", type:"nonconforming",
    desc:"Any sealed container — aerosol cans, propane cylinders, hydraulic accumulators, sealed pipes, or closed pressure vessels — mixed into a scrap charge. When submerged in liquid steel at 1650°C, trapped gas or residual product flash-vaporizes and the vessel ruptures explosively, ejecting molten steel and shrapnel at lethal velocity. ISRI specs require all containers to be open at both ends.",
    uses:["Explosive Rupture in Furnace","Molten Steel Ejection","Roof & Electrode Damage","Operator Fatality Risk"],
    properties:{"ISRI Requirement":"Open at both ends — no sealed ends","Common Sources":"Aerosols, propane tanks, accumulators","Burst Pressure":"10–300+ bar internal pre-burst","Detection":"Visual + piece-by-piece inspection"},
    grades:"ISRI Grade 200 (HMS #1) and all other grades require containers to be open — both ends cut or pierced — before charging. Sealed containers are immediately segregated. Scrap processors use shears or torch to open suspect pieces. Some automated shredder lines miss small sealed containers (aerosol cans) that escape visual inspection.",
    millRole:"A sealed aerosol can in a 150-ton EAF heat explodes with enough force to crack a furnace roof panel or shatter a graphite electrode. A propane cylinder can cause a full molten-steel eruptive event. Every EAF has at least one historical incident logged. The risk is why scrap inspectors at the gate physically probe loads for hidden containers.",
    studentNote:"Think of dropping a sealed soda can into a campfire — it explodes and sends metal fragments flying. Now scale that up to a sealed propane tank inside 150 tons of molten steel at 1650°C. The explosion can punch through the furnace roof and send molten steel raining down on operators. One sealed container can shut a mill down for days.",
    img:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Aerosol.png/330px-Aerosol.png" },

  { id:"lithium-batteries", symbol:"LiB", name:"Lithium Batteries", subtitle:"Thermal Runaway & Fire Hazard in Scrap Stream", type:"nonconforming",
    desc:"Lithium-ion and lithium-polymer cells from EVs, power tools, e-bikes, laptops, and consumer electronics mixed into scrap. Mechanical damage during shredding punctures cells, triggering thermal runaway — an uncontrolled exothermic reaction reaching 700–1000°C that cannot be extinguished with water. As EV adoption grows, Li battery fires are the fastest-growing safety crisis in scrap processing.",
    uses:["Shredder Fire / Facility Loss","Thermal Runaway — Unextinguishable","Toxic HF Gas Release","EAF Chemistry Contamination (Li, F)"],
    properties:{"Thermal Runaway Temp":"700–1000°C self-sustaining","Detection":"X-ray, visual, weight screening","Fire Suppression":"Immersion in water only (containment)","EAF Impact":"Li vaporizes; F attacks refractory"},
    grades:"No current ISRI grade covers Li battery scrap for EAF use — it is categorically rejected. Battery recyclers (hydrometallurgical) process separately. EV battery packs require full discharge and module-level disassembly before any processing. Mixed consumer electronics scrap (e-scrap) is screened and batteries hand-sorted before shredding.",
    millRole:"A Li battery pack from an EV contains enough energy to burn a shredder building to the ground — several North American shredder fires per year are attributed to Li batteries. If a cell survives into an EAF charge, lithium vapor attacks refractories and fluorine from electrolyte salt (LiPF₆) corrodes electrodes and off-gas systems.",
    studentNote:"A Li-ion battery stores enormous energy in a very small space. When the separator inside is punctured, it short-circuits and the stored energy releases as heat almost instantly — faster than any fire suppression system can respond. Water doesn't stop it; you can only drown it. This is why EVs involved in crashes must be monitored for 72 hours before being scrapped.",
    img:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Li_ion_laptop_battery.jpg/330px-Li_ion_laptop_battery.jpg" },
];
